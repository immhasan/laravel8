        ...
        <div class="sidebar-scroll">
            ...
            <nav id="left-sidebar-nav" class="sidebar-nav">
                <ul id="main-menu" class="metismenu">
                    ...
                    <li><a href="{{asset('hrms/index.html')}}"><i class="icon-rocket"></i><span>HRMS System</span></a></li>
                    <li><a href="{{asset('jobportal/index.html')}}"><i class="icon-badge"></i><span>Job Portal</span></a></li>
                    <li><a href="{{asset('landing/index.html')}}"><i class="icon-cursor"></i><span>Landing Page</span></a></li>
                    ...
                    <li><a href="{{asset('documentation/index.html')}}"><i class="icon-doc"></i><span>Documentation</span></a></li>
                </ul>
            </nav>
        </div>
    </div>
